...
function SelectLocation{
   ...
   <# if ($RadioButton1.Checked -and (!($RadioButton2.Checked))) {
        ...
        Write-Host "Something went wrong - please contact IT Support"
    }#>
...
if ([string]::IsNullOrEmpty($grouptag)) {
	Write-Host "Error in script. Please contact IT Support" -BackgroundColor Red -ForegroundColor White
	Start-Sleep 30
    exit 1
} else {
